...
abstract class TestHostVideoPlayerApi {
  ...
  static void setup(TestHostVideoPlayerApi? api, {BinaryMessenger? binaryMessenger}) {
    ...
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.video_player_avfoundation.AVFoundationVideoPlayerApi.setSystemControls', codec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, null);
      } else {
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, (Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.video_player_avfoundation.AVFoundationVideoPlayerApi.setSystemControls was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final SystemControlsMessage? arg_msg = (args[0] as SystemControlsMessage?);
          assert(arg_msg != null,
              'Argument for dev.flutter.pigeon.video_player_avfoundation.AVFoundationVideoPlayerApi.setSystemControls was null, expected non-null SystemControlsMessage.');
          try {
